...
<form class="day_post" method="post" name="day_post" action="mission_6_postday.php">
...
<!--投稿フォーム-->
<div class="post_all">
 <form class="post"  enctype="multipart/form-data" method="post" action="mission_6_postday.php">
 
    <div class="time">
    <input type="text" class="post_date" name="post_date" value="<?php echo $_SESSION['year'].'年'.$_SESSION['month'].'月'.$_GET['d'].'日';?>" readonly/>
    <input type="hidden" class="post_date_hid" name="post_date_hid" value="<?php echo $_SESSION['year'].$_SESSION['month'].$_GET['d'];?>" readonly/>
    </div>
